    ...
    try:
        with SessionLocal() as db:
            ...
            new_user = create_user_db(
                db, first_name, email, phone, password, profile_picture_data)
...
def create_user_db(db: Session, first_name: str, email: str, phone: str, password: str, profile_picture_data: bytes) -> User:
